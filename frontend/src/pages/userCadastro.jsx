                    ...
                    <form onSubmit={handleSubmit} className="bg-white p-10 rounded-lg shadow-lg w-96 text-center">
                        ...
                        <div className="relative mb-6">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-lg"
                            />
                            {showPassword ? <AiOutlineEye className="cursor-pointer absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 text-xl"
                                                                                    onClick={handleClickShowPassword}/> : <AiOutlineEyeInvisible className="cursor-pointer  absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 text-xl"                                                                                                                                            onClick={handleClickShowPassword}/>}
                        </div>
                        ...
                        <div className="relative mb-8">
                            ...
                            />
                            {showPassword ? <AiOutlineEye className="cursor-pointer absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 text-xl"
                                                                                    onClick={handleClickShowPassword}/> : <AiOutlineEyeInvisible className="cursor-pointer  absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 text-xl"
                                                                                                                                                onClick={handleClickShowPassword}/>}                    </div>
                        
                        <button
                            type="submit"
                            className="cursor-pointer w-full bg-green-600 text-white py-3 px-6 rounded-md text-xl font-semibold flex items-center justify-center gap-2 hover:bg-green-700 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
                        >
